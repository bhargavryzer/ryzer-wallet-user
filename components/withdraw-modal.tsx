...
import { ReviewWithdrawalModal } from "./review-withdrawal-modal"
    ...
    <>
      <Dialog open={isOpen && !isReviewModalOpen} onOpenChange={(open) => !open && onClose()}>
        <DialogContent className="sm:max-w-md">
          ...
          <DialogDescription>Transfer money from your account to your bank account.</DialogDescription>

          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Label htmlFor="amount">Amount</Label>
                <span className="text-sm text-gray-500">Available: {formatCurrency(availableBalance)}</span>
              </div>
              <div className="relative">
                ...
                <Button
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 h-6 text-blue-500 hover:text-blue-600"
                >
                  Max
                </Button>
              </div>
