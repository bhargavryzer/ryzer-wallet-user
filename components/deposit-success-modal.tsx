...
export function DepositSuccessModal({ isOpen, onClose, amount }: DepositSuccessModalProps) {
  ...
  const handleNewDeposit = () => {
    // Close this modal and open a new deposit modal
    onClose()
  }
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md text-center">
        ...
        <h2 className="text-xl font-semibold mb-2">Deposit Initiated</h2>
        <p className="text-gray-600 mb-6">
          Your deposit of {formatCurrency(amount)} has been initiated and will be processed shortly.
        </p>
